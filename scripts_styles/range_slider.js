/*! jQRangeSlider 5.7.1 - 2015-01-23

Copyright (C) Guillaume Gautreau 2012 - MIT and GPLv3 licenses.
...
!function (a) {
    ...
    a.widget("ui.dateRangeSliderHandle", a.ui.rangeSliderHandle, {
        _steps: !1, _boundsValues: {}, _create: function () {
            ...
            var a = new Date(this.options.bounds.min.valueOf()), b = new Date(this.options.bounds.max.valueOf()), c = a, d = 0, e = new Date;
